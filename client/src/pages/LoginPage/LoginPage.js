  ...
  render() {
    ...
    return (
      <Box className="login">
        ...
        />
        <h2 className="title is-2 has-text-centered" style={{ color: '#93bccf' }}>Welcome to cenote.VITAL&apos;s Dashboard</h2>
        <FormInput
        ...
        <p align="center">
          {'Forgot password?  '}
          <Link to="/recovery" style={{ color: '#93bccf' }}>Click here!</Link>
        </p>
        <hr style={{
          backgroundColor: '#263855',
          height: '1px',
          margin: '.5rem',
        }}
        />
